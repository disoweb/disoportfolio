...
- June 26, 2025. Fixed critical timeline display bug where landing page projects incorrectly showed "3 weeks" instead of "4 days": enhanced database schema with timelineDays field, implemented intelligent timeline display logic that shows days for short projects (≤7 days) and weeks for longer projects, updated 15 existing landing page projects with accurate 4-day timelines, and added real-time countdown with seconds precision updating every second instead of every minute