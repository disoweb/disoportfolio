...
- June 26, 2025. Completely redesigned CheckoutForm component to implement direct authentication-to-PaymentLoader-to-Paystack flow: authenticated users with pending checkout data now bypass the checkout form entirely, going straight to payment processing with immediate PaymentLoader display, eliminating the unwanted dashboard flash sequence